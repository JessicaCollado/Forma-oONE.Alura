...
var numero = parseFloat(prompt('Insira qualquer valor:'));

    if (numero < 0){
        console.log('O número que você escolheu é negativo!');
    } else {
        if (numero = 0)
        console.log('O número que você escolheu é o zero!');
    } else {
        console.log('O número que você escolheu é positivo!');
    }
